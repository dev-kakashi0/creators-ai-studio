...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Solenya — Studio de création IA" },
      {
        name: "description",
        content:
          "Solenya réunit ebooks, visuels, copywriting et vidéo IA dans un seul studio de création.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    const stored = window.localStorage.getItem("solenya-theme");
